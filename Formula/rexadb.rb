class Rexadb < Formula
  ...
  homepage 'https://github.com/rexadbapp/rexadb'
  license 'MIT'
  version '0.1.0'

  on_macos do
    if Hardware::CPU.intel?
      url 'https://github.com/rexadbapp/rexadb/releases/download/v0.1.0/rexadb-darwin-amd64'
      sha256 '1a64d4a24ebb4e5d563e77e1a7f2a5d4a997c7e42dfc48eeb2ac88a1db93bc98'
    else
      url 'https://github.com/rexadbapp/rexadb/releases/download/v0.1.0/rexadb-darwin-arm64'
      sha256 '1594a2e22f306c6000d3b66131b9ba4dbb454bfd9735ac8c33c7402ccae48312'
    end
  end

  on_linux do
    url 'https://github.com/rexadbapp/rexadb/releases/download/v0.1.0/rexadb-linux-amd64'
